...
class DisHistory1 extends Component {
  constructor(props){
  super(props);
  this.state={
    data:[],
  ...
  <p>{list.crollno}</p>
         ...
         { time = list.time }
          <CardActions>
            ...
            <RaisedButton label=" Click to Cancel " style={buttonStyle} onClick={()=>this.handleCancel(index)}/>
          </CardActions>
        </Card>
